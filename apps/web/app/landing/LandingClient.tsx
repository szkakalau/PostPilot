        ...
        <div className="card landingCard heroLeft">
          ...
          <div className="heroCopy">
            ...
            <h1 className="h1" style={{ marginTop: 14 }}>
              Stop paying <span style={{ color: "var(--accent2)" }}>$150–$400/month</span> for tools that don’t write.
            </h1>
            <p className="muted lead" style={{ marginTop: 6 }}>
              PostPilot is the <strong>$19/month</strong> AI social scheduling tool for Twitter + LinkedIn — write with AI,
              schedule once, publish automatically. <strong>Launching soon.</strong>
            </p>
      ...
      <section className="section" id="stack">
        <div className="card landingCard">
          ...
          <p className="muted" style={{ marginTop: 0, maxWidth: 900 }}>
            If you’re a freelancer or small agency, you’ve probably ended up stacking tools to “cover everything”:
          </p>
          ...
          <hr className="hr" />
          <p style={{ margin: 0 }}>
            That stack quietly turns into <b>$150–$400/month</b> — and you still have to write the posts yourself (or pay
        ...
        <div className="card landingCard">
          ...
          <div className="featureGrid" style={{ marginTop: 12 }}>
            <div className="card">
              ...
              <p className="muted" style={{ margin: 0 }}>
                Generate posts in seconds for Twitter or LinkedIn. Rewrite, shorten, expand, or change tone until it
                sounds like you. Go from “blank page” to ready-to-post fast.
              </p>
            </div>
            <div className="card">
              ...
              <p className="muted" style={{ margin: 0 }}>
                Pick your cadence and let PostPilot handle the calendar. Queue posts, avoid gaps, and schedule in
                batches. Set it once — your content keeps shipping.
              </p>
            </div>
            <div className="card">
              ...
              <p className="muted" style={{ margin: 0 }}>
                Manage multiple profiles without the agency-tier price tag. Keep accounts organized and publishing
                consistently. Built for small teams with real constraints.
              </p>
            </div>
            <div className="card">
              <h3 className="h3">Twitter + LinkedIn first</h3>
              <p className="muted" style={{ margin: 0 }}>
                No “everything to everyone” roadmap. Just the two platforms most freelancers and indie teams actually
                use to get leads.
              </p>
              <hr className="hr" />
              <button className="btn" type="button" onClick={jumpToWaitlist}>
